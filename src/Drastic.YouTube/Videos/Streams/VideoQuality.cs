// <copyright file="VideoQuality.cs" company="Drastic Actions">
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="VideoQuality"/> struct.
    ...
    /// <summary>
    /// Gets quality label as seen on YouTube (e.g. 1080p, 720p60, etc).
    /// </summary>
    public string Label { get; }

    /// <summary>
    /// Gets maximum established height of the video stream.
    /// Actual height can vary.
    /// </summary>
    public int MaxHeight { get; }

    /// <summary>
    /// Gets video stream framerate (in frames per second).
    /// </summary>
    public int Framerate { get; }

    /// <summary>
    /// Gets a value indicating whether whether this is a high definition video quality (i.e. 1080p or above).
    /// </summary>
    public bool IsHighDefinition => this.MaxHeight >= 1080;

    /// <inheritdoc />
    public override string ToString() => this.Label;

    internal Resolution GetDefaultVideoResolution() => this.MaxHeight switch
    {
        ...
        _ => new Resolution(16 * this.MaxHeight / 9, this.MaxHeight),
    };
}
...
public partial struct VideoQuality : IComparable<VideoQuality>, IEquatable<VideoQuality>
{
    ...
    {
        var maxHeightComparison = this.MaxHeight.CompareTo(other.MaxHeight);
        var framerateComparison = this.Framerate.CompareTo(other.Framerate);
    ...
    /// <inheritdoc />
    public bool Equals(VideoQuality other) => this.CompareTo(other) == 0;

    /// <inheritdoc />
    public override bool Equals(object? obj) => obj is VideoQuality other && this.Equals(other);

    /// <inheritdoc />
    public override int GetHashCode() => HashCode.Combine(this.MaxHeight, this.Framerate);
}