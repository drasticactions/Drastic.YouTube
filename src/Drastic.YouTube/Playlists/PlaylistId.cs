// <copyright file="PlaylistId.cs" company="Drastic Actions">
...
public partial struct PlaylistId : IEquatable<PlaylistId>
{
    ...
    /// <inheritdoc />
    public bool Equals(PlaylistId other) => StringComparer.Ordinal.Equals(this.Value, other.Value);

    /// <inheritdoc />
    public override bool Equals(object? obj) => obj is PlaylistId other && this.Equals(other);
